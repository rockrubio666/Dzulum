...
def getParams(arg):
	...
	if int(options.verbose)	>= 4 or int(options.verbose) == 0:
		...
		elif options.ojs in sys.argv and options.Cookie in sys.argv and options.Agent in sys.argv:
		...
		elif options.ojs in sys.argv and options.Cookie in sys.argv:
		...
		elif options.ojs in sys.argv and options.Agent in sys.argv:
